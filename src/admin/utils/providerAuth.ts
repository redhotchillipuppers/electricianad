...
/**
 * Create initial provider account (use this to set up provider accounts)
 */
export const createProviderAccount = async (email: string, password: string): Promise<ProviderUser> => {
  try {
